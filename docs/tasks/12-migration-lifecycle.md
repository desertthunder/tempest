...
- [x] T12-08: Implement `listMissingBlobs` from indexed imported records.
- [x] T12-09: Implement `activateAccount` with DID-document/PDS-location verification.
- [x] T12-10: Implement `deactivateAccount`.
- [x] T12-11: Implement `requestAccountDelete` and `deleteAccount`.
