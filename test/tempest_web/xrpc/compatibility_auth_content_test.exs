defmodule TempestWeb.Xrpc.CompatibilityAuthContentTest do
  ...
  @client_id "https://compat-client.example.com/oauth/client-metadata.json"
  ...
  setup context do
    ...
    Application.put_env(:tempest, ExternalMetadataFetcher,
      dns_lookup: fn "compat-client.example.com" -> {:ok, [{93, 184, 216, 34}]} end,
  ...
  defp client_metadata do
    %{
      "client_id" => @client_id,
      "client_name" => "Compatibility Auth Test Client",
